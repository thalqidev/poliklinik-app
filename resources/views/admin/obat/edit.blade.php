                        ...
                        <form action="{{ route('obat.update', $obat->id) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="kemasan" class="form-label">kemasan <span
                                                class="text-danger">*</span></label>
                                        <input type="kemasan" name="kemasan" class="form-control" value="{{ old('kemasan', $obat->kemasan) }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="harga" id="harga"
                                    class="form-control"  value="{{ old('harga', $obat->harga) }}" required min="0" step="1">
                            </div>
